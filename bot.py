...
client = MongoClient("mongodb+srv://safwandigi:Fazal2002@test.kzjdjnu.mongodb.net/?retryWrites=true&w=majority&appName=test")  # Update with your connection string if necessary
